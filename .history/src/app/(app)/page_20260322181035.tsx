    ...
    <main className="bg-black text-white overflow-hidden">
      ...
      <nav className="fixed top-0 w-full z-50 backdrop-blur border-b border-white/10">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <h1 className="font-bold text-xl">ViralScale</h1>
      ...
      <section className="min-h-screen flex flex-col justify-center items-center text-center px-6 relative">
        <div className="absolute inset-0 bg-gradient-to-b from-purple-600/20 to-transparent blur-3xl" />
        ...
        <div className="mt-8 flex gap-4">
          <Button className="bg-white text-black px-6 py-6 text-lg">
            Get Started
          </Button>
      ...
      <section className="py-32 text-center px-6">
        ...
        <Button className="bg-white text-black px-10 py-6 text-lg">
          Get Started Now
        </Button>
      </section>
      ...
      <footer className="py-10 text-center text-gray-500 border-t border-white/10">
        © {new Date().getFullYear()} ViralScale. All rights reserved.
      </footer>
    </main>
  );
}
